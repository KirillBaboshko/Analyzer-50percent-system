        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-col items-center md:items-start gap-2">
            <p className="text-sm text-dota-muted">
              © {currentYear} Dota 2 Analyzer. Все права защищены.
            </p>
            <p className="text-xs text-dota-muted/70">
              Данные предоставлены{" "}
              <a
                href="https://stratz.com"
                target="_blank"
                rel="noopener noreferrer"
                className="text-dota-dire hover:underline inline-flex items-center gap-1"
              >
                STRATZ API
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <span className="hidden sm:inline">Исходный код</span>
            </a>
          </div>
        </div>
      </div>
